...
class StockValuationLayerRevaluation(models.TransientModel):
    ...
    new_value_in_currency = fields.Monetary("New value", compute='_compute_new_value_in_currency')
    new_value_in_currency_by_qty = fields.Monetary("New value by quantity", compute='_compute_new_value')
